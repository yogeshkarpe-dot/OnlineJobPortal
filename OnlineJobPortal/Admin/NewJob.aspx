        ...
        <div class="container pt-4 pb-4">
            ...
            <div class ="btn-toolbar justify-content-between mb-3">
                ...
                <div class="input-group h-25">
                    <asp:HyperLink ID="LinkBack" NavigateUrl="~/Admin/JobList.aspx" CssClass="btn btn-secondary" Visible="false" runat="server">< Back</asp:HyperLink>
                </div>
            </div>
            ...
            <div class="row mr-lg-5 ml-lg-5 mb-3">
                ...
                <div class="col-md-6 pt-3">
                    <label for="txtNoOfPositions" style="font-weight: 600;">Number of Positions</label>
                    <asp:TextBox ID="txtNoOfPositions" runat="server" CssClass="form-control" placeholder="Enter Number of Positions" TextMode="Number" required></asp:TextBox>
                </div>
            </div>
            <div class="row mr-lg-5 ml-lg-5 mb-3">
            ...
            <div class="row mr-lg-5 ml-lg-5 mb-3">
                <div class="col-md-6 pt-3">
                    ...
                    <asp:TextBox ID="txtQualification" runat="server" CssClass="form-control" placeholder="Ex. BTech, BE, MCA" required></asp:TextBox>
                </div>
                <div class="col-md-6 pt-3">
                    <label for="txtExperience" style="font-weight: 600;">Experience Required</label>
                    <asp:TextBox ID="txtExperience" runat="server" CssClass="form-control" placeholder="Ex. 2 Yeras, 1.5 Years" required></asp:TextBox>
                </div>
            </div>
            <div class="row mr-lg-5 ml-lg-5 mb-3">
                <div class="col-md-6 pt-3">
            ...
            <div class="row mr-lg-5 ml-lg-5 mb-3">
                <div class="col-md-6 pt-3">
                    ...
                    <asp:TextBox ID="txtSalary" runat="server" CssClass="form-control" placeholder="Enter Salary" TextMode="MultiLine" required></asp:TextBox>
                </div>
                <div class="col-md-6 pt-3">
            ...
            <div class="row mr-lg-5 ml-lg-5 mb-3">
                ...
                <div class="col-md-6 pt-3">
                    ...
                    <asp:FileUpload ID="fuCompanyLogo" CssClass="form-control" ToolTip=".jpg, .jpeg, .png extention only" runat="server" />
                </div>
            </div>
            <div class="row mr-lg-5 ml-lg-5 mb-3">
                <div class="col-md-6 pt-3">
                    <label for="txtWebsite" style="font-weight: 600;">Website</label>
                    <asp:TextBox ID="txtWebsite" runat="server" CssClass="form-control" placeholder="Enter Website URL" TextMode="Url"></asp:TextBox>
                </div>
                <div class="col-md-6 pt-3">
